...
export function useDocumentRequirements(documentId: string, queryFilters?: Omit<QueryFilters, 'filters'>) {
  return useQuery({
...
export function useBlockRequirements(blockId: string, queryFilters?: Omit<QueryFilters, 'filters'>) {
  return useQuery({
