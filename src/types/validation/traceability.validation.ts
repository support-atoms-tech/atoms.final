...
export const TraceLinkSchema = z.object({
    ...
    link_type: z.enum(["derives_from", "implements", "relates_to", "conflicts_with", "is_related_to", "parent_of", "child_of"]) as z.ZodType<TraceLinkType>,
    source_id: z.string(),
...
export const AssignmentSchema = z.object({
    ...
    is_deleted: z.boolean().nullable(),
    role: z.enum(["assignee", "reviewer", "approver"]) as z.ZodType<AssignmentRole>,
...
export const UserRoleSchema = z.object({
    id: z.string(),
    created_at: z.string(),
    role: z.enum(["member", "admin", "owner", "super_admin"]) as z.ZodType<UserRoleType>,
    updated_at: z.string(),
    user_id: z.string(),
