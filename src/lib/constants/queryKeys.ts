...
export const queryKeys = {
    ...
    blocks: {
        ...
        detail: (id: string) => [...queryKeys.blocks.root, 'detail', id] as const,
    ...
    requirements: {
        ...
        detail: (id: string) => [...queryKeys.requirements.root, 'detail', id] as const,
        byDocument: (documentId: string) =>
    ...
    properties: {
        ...
        detail: (id: string) => [...queryKeys.properties.root, 'detail', id] as const,
        byDocument: (documentId: string) =>
    ...
    projects: {
        ...
        detail: (id: string) => [...queryKeys.projects.root, 'detail', id] as const,
        byOrg: (orgId: string) =>
    ...
    profiles: {
        ...
        detail: (id: string) => [...queryKeys.profiles.root, 'detail', id] as const,
    ...
    organizations: {
        ...
        detail: (id: string) => [...queryKeys.organizations.root, 'detail', id] as const,
        byUser: (userId: string) =>
    ...
    traceLinks: {
        ...
        bySource: (sourceId: string, sourceType: string) =>
            [...queryKeys.traceLinks.root, 'source', sourceId, sourceType] as const,
        byTarget: (targetId: string, targetType: string) =>
            [...queryKeys.traceLinks.root, 'target', targetId, targetType] as const,
    },

    assignments: {
        root: ['assignments'] as const,
        byEntity: (entityId: string, entityType: string) =>
            [...queryKeys.assignments.root, 'entity', entityId, entityType] as const,
        byUser: (userId: string) =>
    ...
    notifications: {
        ...
        byUser: (userId: string) => [...queryKeys.notifications.root, userId] as const,
